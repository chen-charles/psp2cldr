...
#define DEFINE_VITA_IMP_NID_EXPORT(libraryNID, functionNID)                                                                                                    \
	VITA_EXPORT VITA_IMP_RETURN_TYPE VITA_EXPORT_CONVENTION VITA_IMP_NID_EXPORT_NAME(libraryNID, functionNID)(InterruptContext * ctx)

#define DECLARE_VITA_IMP_SYM_EXPORT(name) VITA_EXPORT VITA_IMP_RETURN_TYPE VITA_EXPORT_CONVENTION VITA_IMP_SYM_EXPORT_NAME(name)(InterruptContext *);
